...
public class TopNumber extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Numbers {
    ...
    /**
     * Create a request for the method "numbers.listPlayers".
     *
     * This request holds the parameters needed by the topNumber server.  After setting any optional
     ...
     * @return the request
     */
    public ListPlayers listPlayers(java.lang.String playerIds) throws java.io.IOException {
      ListPlayers result = new ListPlayers(playerIds);
      initialize(result);
      return result;
    }

    public class ListPlayers extends TopNumberRequest<com.moybl.topnumber.backend.topNumber.model.PlayerCollection> {

      private static final String REST_PATH = "player/{playerIds}";
       ...
       * @since 1.13
       */
      protected ListPlayers(java.lang.String playerIds) {
        super(TopNumber.this, "POST", REST_PATH, null, com.moybl.topnumber.backend.topNumber.model.PlayerCollection.class);
        this.playerIds = com.google.api.client.util.Preconditions.checkNotNull(playerIds, "Required parameter playerIds must be specified.");
      }
      ...
      @com.google.api.client.util.Key
      private java.lang.String playerIds;
      ...
      public ListPlayers setPlayerIds(java.lang.String playerIds) {
    ...
    public class ListTop extends TopNumberRequest<com.moybl.topnumber.backend.topNumber.model.ListPlayersResponse> {

      private static final String REST_PATH = "listTop";
       ...
       */
      protected ListTop() {
        super(TopNumber.this, "GET", REST_PATH, null, com.moybl.topnumber.backend.topNumber.model.ListPlayersResponse.class);
      }
      ...
      public ListTop setNextPageToken(java.lang.String nextPageToken) {
  ...
  public class Players {
    ...
    public class ChangeName extends TopNumberRequest<com.moybl.topnumber.backend.topNumber.model.Player> {
